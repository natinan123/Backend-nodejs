...
var match = {
    match: function (data, callback) {
        ...
        WHERE EXISTS
            ...
            SELECT *
            FROM requirement
            WHERE 	requirement.email_id = '${email_id}' AND
                                property.location_id = requirement.location_id AND
                                property.type_id = requirement.type_id AND
                                property.price BETWEEN requirement.req_price_min AND requirement.req_price_max AND
                                property.pro_area BETWEEN requirement.req_area_min AND requirement.req_area_max 
