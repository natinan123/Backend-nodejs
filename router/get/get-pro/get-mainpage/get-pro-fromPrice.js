...
var price = require('../../../../service/select/get-pro/get-mainpage/get-pro-fromPrice');
const fs = require('fs');
var partImage = require('../../../partImage');
var moment = require('moment'); moment.locale('th'); // เวลา

// router.get('/:price_min/:price_max', function (req, res, next) {
router.post('/', function (req, res, next) {

    var data = req.body;
    // var data = {
    //     price_min: req.params.data.price_min,
    //     price_max: req.params.data.price_max,

    // }
    price.price(data, (err, row) => {
